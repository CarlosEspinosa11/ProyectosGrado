...
<html lang="en">
        ...
        <body> <br><br><br><br>
         <center>   <section id="features" class="padd-section text-center wow fadeInUp">
                <div class="container">
                    <div class="section-title text-center">
                        <h1 class="d-flex justify-content-center">EVALUADOR</h1><br><br>
                    </div>
                </div>
                ...
                <div class="container" id="contenedor-principal">
                    <div class="row d-flex justify-content-center" id="fila-2">    
                        <div class="col-md-6 col-lg-4">
                            <a href="vista_subidaproeva.jsp">
                                <div class="feature-block">
                                    <img src="images/estudiante.png" alt="img" class="img-fluid">
                                    <h4>ANTEPROYECTOS ALUMNOS</h4>
                                </div>
                            </a>
                        </div>
        
                        <div class="col-md-6 col-lg-4">
                            <a href="vista_aprobareva.jsp">
                                <div class="feature-block">
                                    <img src="images/aprobar.png" alt="img" class="img-fluid">
                                    <h4>APROBAR ANTEPROYECTOS</h4>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <center><a href="principal_doc.jsp"><input id="botonn"  class="btn btn-dark" type="submit" value="Regresar "/></a></center>
