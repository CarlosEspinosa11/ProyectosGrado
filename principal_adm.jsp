...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Abyssinica+SIL&family=Rubik&display=swap" rel="stylesheet">
            ...
            <section id="features" class="padd-section text-center wow fadeInUp">
                <div class="container">
                    <div class="section-title text-center">
                        <h1 class="d-flex justify-content-center   "><center>ADMINISTRADOR</h1><br><br>
                    </div>
                </div>
                ...
                <div class="container" id="contenedor-principal">
                    <div class="row d-flex justify-content-center" id="fila-2">
                        <div class="col-md-6 col-lg-4">
                            <a href="vista_estudiante.jsp">
                                <div class="feature-block">
                                    <img src="images/estudiante.png" alt="img" class="imagen
                                ">
                                    <h4>CRUD ESTUDIANTE</h4>
                                </div>
                            </a>
                        </div>
                    
                        <div class="col-md-6 col-lg-4">
                            <a href="vista_docente.jsp">
                                <div class="feature-block">
                                    <img src="images/docente.png" alt="img" class="img-fluid">
                                    <h4>CRUD DOCENTE</h4>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row d-flex justify-content-center" id="fila-2">
                        <div class="col-md-6 col-lg-4">
                            <a href="vista_coordinacion.jsp">
                                <div class="feature-block">
                                    <img src="images/coordinador.png" alt="img" class="img-fluid">
                                    <h4>CRUD COORDINADOR</h4>
                                </div>
                             </a>
                        </div>
