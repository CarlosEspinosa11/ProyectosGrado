...
<html lang="en">
    <head>
        ...
        <title>PARCIAL 2 CORTE</title>
    </head>

    <body> <br><br><br><br><br>   
     
        <section id="features" class="padd-section text-center wow fadeInUp"><br><br><br><br>
            <div class="container">
                <div class="container " id="contenedor-principal ">
                    <div class="row d-flex justify-content-center" id="fila-2">            
                        <div class="col-md-6 col-lg-4">
                            <a href="login_adm.jsp">
