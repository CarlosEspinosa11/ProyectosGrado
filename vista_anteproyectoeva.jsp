...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body> <br><br><br><br><br><br>
            ...
            <h2 class="text-black"><center>AnteProyecto Evaluador</center></h2>
            ...
            <sql:query var="result" scope="request" dataSource="${parcialsegundocorte}">
                ...
                estudiante.contra_est as contra, director.nom_director as director, evaluador.nom_evaluador as evaluador
                from estudiante
                left join director
        ...
        <fieldset class="contenedor"> <br><br><br>
                    ...
                    <tbody>
                        <c:forEach var="fila" items="${result.rows}">
                            <tr>
                                ...
                                <td><br><a href="actualizarAPEvaluador.jsp?id=${fila.id}">
            ...
            <center> <a href="principal_cor.jsp"> <input id="botonn"  class="btn btn-dark" type="submit" value="Regresar "/></a></center>
        </fieldset>
