...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>APROBAR DIRECTOR</title>
        </head>

        <body> <br><br><br><br><br><br>
            <h1 class="text-black"><center>Sistema Universitario</center></h1>
            <h2 class="text-black"><center>Calificacion Ante Proyecto</center></h2>
            ...
            <sql:query var="result" scope="request" dataSource="${parcialsegundocorte}">
                ...
                aprobarproyecto.estado as estado
                from estudiante
        ...
        <fieldset class="contenedor"> <br><br><br>
            <center><table border="1" class="table table-striped table-hoverb">
                    <thead >
                        <tr><th>Cedula</th>
                            ...
                            <th>Fecha</th>
                            <th>Estado</th>
                             <th colspan="1"><center> Acciones </center> </th></tr>
                    </thead>
                    ...
                    <tbody>
                        <c:forEach var="fila" items="${result.rows}">
                            <tr>
                                ...
                                <td><br><a href="actualizarCalifaciondir.jsp?id=${fila.id}">
                                    <input id="botonn" class="btn btn-success" type="submit" value="Calificar"/></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
            </table></center> 
            ...
            <center> <a href="principal_dir.jsp"> <input id="botonn"  class="btn btn-dark mb-3" type="submit" value="Regresar "/></a></center>
         </fieldset>
