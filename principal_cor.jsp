        ...
        <section id="features" class="padd-section text-center wow fadeInUp">
            <div class="container">
                <div class="section-title text-center">
                    <h1 class="d-flex justify-content-center   ">COORDINADOR</h1><br><br>
                </div>
            </div>
            ...
            <div class="container" id="contenedor-principal">
                <div class="row d-flex justify-content-center" id="fila-2">
                    <div class="col-md-6 col-lg-4">
                        <a href="vista_radicadocor.jsp">
                            <div class="feature-block">
                                <img src="images/radicado.png" alt="img" class="img-fluid">
                                <h4>RADICADO ANTEPROYECTO</h4>
                            </div>
                        </a>
                    </div>
        
                    <div class="col-md-6 col-lg-4">
                        <a href="vista_anteproyectodir.jsp">
                            <div class="feature-block">
                                <img src="images/director.png" alt="img" class="img-fluid">
                                <h4>ANTEPROYECTO DIRECTOR</h4>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-center" id="fila-2">
                    <div class="col-md-6 col-lg-4">
                        <a href="vista_anteproyectoeva.jsp">
                            <div class="feature-block">
                                <img src="images/evaluador.png" alt="img" class="img-fluid">
                                <h4>ANTEPROYECTO EVALUADOR</h4>
                            </div>
                        </a>  
                    </div>
