...
<br><br><br><br><br><br>
<center><h2>Subir Radicado</h2></center>
<br>
      <form method="post">
        <center><table class="tabla">
              <c:forEach var="itema" items="${universidad.rows}">
                ...
                <tr><td>Radicado</td>
                    <td><input type="text" name="radicado" value="${itema.radicado_est}"></td>
                </tr>
    ...
    <c:if test="${param.modifica != null}" >
      ...
      <br><br><br><br> <br><br><br><br>
        <center>  <div class="card" style="width: 18rem;">
          <div class="card-body">
            <p class="text-black">Radicado Subido Correctamente!</p>
            <a class="btn btn-dark"  href="vista_radicadocor.jsp">Regresar</a>
          </div>
        </div></center>
      </c:if>
    </c:if>
