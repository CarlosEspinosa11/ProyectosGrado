...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>VISTA RADICADO</title>
        </head>

        <body> <br><br><br><br><br><br>
            <h1 class="text-black"><center>Sistema Universitario</center></h1>
            <h2 class="text-black"><center>Radicado Coordinacion</center></h2>
            ...
            <sql:query var="result" scope="request" dataSource="${parcialsegundocorte}">
                ...
                estudiante.contra_est as contra, aprobarproyecto.estado as estado, estudiante.radicado_est as radicado
                from estudiante
                    ...
                    <tbody>
                        <c:forEach var="fila" items="${result.rows}">
                            <tr>
                                ...
                                <td><br><a href="actualizarRadicadocor.jsp?id=${fila.id}">
                                    <input id="botonn" class="btn btn-success" type="submit" value="Subir"/></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
            </table></center> 
