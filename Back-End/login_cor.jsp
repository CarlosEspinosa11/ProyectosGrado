	...
	<div class="limiter">	
		<div class="container-login100">			
			...
			<c:if test="${param.usuario != null}">
					<sql:query sql="SELECT * FROM coordinacion WHERE cedula_cor=?
							AND contra_cor=?" var="rsCoordinacion" dataSource="${parcialsegundocorte}">
					...
					<c:forEach var="coordinacion" items="${rsCoordinacion.rows}">
						<c:if test= "${coordinacion.cedula_cor.equals(param.usuario)}">
						<c:redirect url = "principal_cor.jsp"/>
						</c:if>
