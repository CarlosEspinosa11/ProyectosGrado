...
<br><br><br><br><br><br>
<center><h2>Subir Proyecto</h2></center>
<br>
      <form method="post">
        <center><table class="tabla">
              <c:forEach var="itema" items="${universidad.rows}">
                ...
                <td> <input type="hidden" name="contra" value="${itema.contra_est}"></td>
                      ...
                      <fieldset>
                            <label for="url_est">Url: </label>
                            <input type="text" required id="nombre_est" name="url" value="${itema.url_est}">
                            <label for="fecha_est">Fecha: </label>
                            <input type="date" required id="nombre_est" name="fecha" value="${itema.fecha_est}">
                      </fieldset>
                          
              </c:forEach>
        </table></center> 

        <center><input class="btn btn-success mp-3" id="boton" type="submit" value="Actualizar"/></center>
      ...
      <br><br><br><br> <br><br><br><br>
        <center>  <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <a class="btn btn-dark" href="vista_subidapro.jsp">Regresar</a>
          </div>
        </div></center>
      </c:if>
    </c:if>
